...
public abstract class GlobalMercator {
...
//		return new double[] { ll[0], ll[1], ur[0], ur[1] };
	...
	/**
	 * Converts TMS tile coordinates to Google TmsTile coordinates
	 * 
	 * @param tx
	 * @param ty
	 * @param zoom
	...
	/**
	 * Converts a lat long coordinates to Google TmsTile Coordinates
	 * 
	 * @param lat
	 * @param lon
	 * @param zoom
    ...
    /**
     * fitures out the tile for a wgs84 coordinate
     *
     * @param lon
     * @param lat
     * @param zoom
